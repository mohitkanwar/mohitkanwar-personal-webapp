...
<img src="assets/images/blogs/log-architecture/unified-log-management.png" alt="Image" alt="An architecture depicting the logging architecture" class="responsive-image-bounded">
</div>
